...
const Createdisabledhealthboardreport = (props) => {
  ...
  return (
    <>
      <div className='row'>
        <h4 className='m-2'>Engelli Kurul Sağlık Raporu</h4>
      </div>
      <div className='row'>
            ...
            <div className='form' onSubmit={(e) => { e.preventDefault() }}>
              <div className='row'>
                ...
                <div className='col' style={{ maxWidth: '30px', marginRight: '10px' }}>
                  <button className="btn btn-info btn-sm icon-btn mb-2 addbtn"  onClick={addItem} ><i className="mdi mdi-plus"></i></button>
                </div>
              </div >
            </div>
          </div>
...
export default Createdisabledhealthboardreport
