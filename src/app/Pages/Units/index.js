...
import { GetAllUnitsSettings,GetSelectedUnit, OpenDeleteModal, CloseDeleteModal } from '../../Redux/actions/UnitActions'
...
export class Units extends Component {
    ...
    componentDidMount() {
        this.props.GetAllUnitsSettings();
    }
...
const mapDispatchToProps = { GetAllUnitsSettings,GetSelectedUnit, OpenDeleteModal, CloseDeleteModal  }
