...
import { UpdateCostumertype, GetSelectedCostumertype } from "../../Redux/actions/CostumertypeActions"
...
export class Edit extends Component {
    ...
    handlesubmit = (e) => {
        ...
        this.setState({ currentitem: newdata }, () => {
            this.props.UpdateCostumertype(this.state.currentitem, this.props.history)
        })
    }

    componentDidMount() {
        this.props.GetSelectedCostumertype(this.props.match.params.CostumertypeId);
        this.props.GetAllDepartments();
    }
    componentDidUpdate() {
        if (this.props.Departments.list.length > 0 &&
            this.state.departments.length === 0 &&
            Object.keys(this.props.Costumertypes.selected_costumertype).length !== 0 &&
            !this.props.Departments.isLoading &&
            !this.props.Costumertypes.isLoading) {

            const prevData = this.props.Costumertypes.selected_costumertype.departments.map((item, index) => {
            ...
            this.setState({ departments: list, selecteddepartments: prevData, currentitem: this.props.Costumertypes.selected_costumertype })
        }
    }

    goBack = (e) => {
        e.preventDefault()
        this.props.history.push("/Costumertypes")
    }
    ...
    render() {
        ...
        const isLoading = (this.props.Departments.isLoading || this.props.Costumertypes.isLoading)
        return (
            <>
                {isLoading ? <Spinner /> :
                    <div className='Page'>
                        <div className="col-12 grid-margin">
                            <div className="card">
                                <div className="card-body">
                                    <h4 className="card-title">Müşteri Türleri > Yeni</h4>
...
const mapDispatchToProps = { UpdateCostumertype,GetSelectedCostumertype, GetAllDepartments }
