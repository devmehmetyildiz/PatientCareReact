...
import { CreateCostumertype} from "../../Redux/actions/CostumertypeActions"
...
export class Create extends Component {
    ...
    handlesubmit = (e) => {
        ...
        this.setState({ currentitem: newdata }, () => {
            this.props.CreateCostumertype(this.state.currentitem, this.props.history)
        })
    }
...
const mapDispatchToProps = { CreateCostumertype, GetAllDepartments }
